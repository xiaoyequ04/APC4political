...
#| eval: false
#| echo: false
t1_wvs <- datasummary(marriage + class_sub + socialLevel + interstpol + trust_gover + trust_gover_max +  trust_party + trust_party_max + trust_civil + trust_parli + dempro + demuti + demimportant + demlevel + leader + expert + army + proud ~ 
...
cbs2008$ecocounrty <- 6 - cbs2008$c6
cbs2008$ecocounrty5 <- 6 - cbs2008$c7
...
cbs2008clean <- cbs2008 %>%
  select(.,id,province,year,weight,age,female,party,edu,interstpol,frepol,socialLevel,hukouRural,marriage,trust_party,trust_party_z,trust_partyR,trust_party_max,trust_gover,trust_gover_z,trust_goverR,trust_gover_max,trust_local,trust_local_z,trust_localR,trust_localR,demlevel,demlevel_usa,demsuit,demsatisify,leader,army,lifestyle,proud,autho,autho1,autho2,autho3,autho4,autho5,autho6,autho7,autho8,autho9,source,ecofamily5,ecofamily,ecocounrty,ecocountry5)
...
cbs2011clean <- cbs2011 %>%
  select(.,id,province,year,weight,age,female,party,edu,interstpol,frepol,socialLevel,hukouRural,marriage,trust_party,trust_party_z,trust_partyR,trust_party_max,trust_gover,trust_gover_z,trust_goverR,trust_gover_max,trust_local,trust_local_z,trust_localR,trust_localR,demlevel,demlevel_usa,demsuit,demsatisify,leader,expert,army,compete,lifestyle,proud,demscore,autho,autho1,autho2,autho3,autho4,autho5,autho6,autho7,autho8,autho9,source,ecofamily5,ecofamily,ecocounrty,ecocountry5)
...
cbs2014$ecocoutry <- 6 - cbs2014$B15
cbs2014$ecocoutry5 <- 6 - cbs2014$B16
...
cbs2014clean <- cbs2014 %>%
  select(.,id,province,year,weight,age,female,party,edu,interstpol,frepol,socialLevel,hukouRural,marriage,trust_gover,trust_gover_z,trust_goverR,trust_gover_max,trust_local,trust_local_z,trust_localR,trust_localR,demlevel,demlevel_usa,demsuit,demsatisify,leader,expert,army,party,lifestyle,proud,demscore,autho,autho2,autho3,autho4,autho5,autho6,autho8,autho9,source,ecofamily5,ecofamily,ecocounrty,ecocountry5)
...
cbs2019$ecocounrty <- 6 - cbs2019$B15
cbs2019$ecocounrty5 <- 6 - cbs2019$B16
...
cbs2019clean <- cbs2019 %>%
  select(.,id,province,year,weight,age,female,party,edu,interstpol,frepol,socialLevel,hukouRural,marriage,trust_party,trust_party_z,trust_partyR,trust_party_max,trust_gover,trust_gover_z,trust_goverR,trust_gover_max,trust_local,trust_local_z,trust_localR,trust_localR,demlevel,demlevel_usa,demsuit,demsatisify,leader,expert,army,party,lifestyle,proud,demscore,autho,autho1,autho2,autho3,autho4,autho5,autho6,autho8,autho9,source,ecofamily5,ecofamily,ecocounrty,ecocountry5)
```
...
gdp2diff <- update(gdppc2demscore, diffpro2uti ~ .)

gdppc2diff <- update(gdp2diff, . ~ . - log(gdp_mean) + log(gdppc_mean))
growth2diff <- update(gdp2diff,.~. - log(gdp_mean) + log(growth_mean))

list_eco2dem <- list(
  gdppc2demscore = gdppc2demscore,
  gdp2diff = gdp2diff,
  gdppc2diff = gdppc2diff,
  growth2diff = growth2diff
)
...
temp <- cbs %>%
  select(.,yearbirth,cohort,autho,leader)
temp_gdp <- temp %>%
  left_join(.,mds_china,by = join_by(yearbirth == year)) %>%
  group_by(cohort) %>%
  mutate(gdppc_mean = mean(gdppc,na.rm = TRUE),
...
gdp2autho_mean <- update(gdppc2autho_mean, . ~ . + log(gdp_mean) - log(gdppc_mean))
gdp2autho <- update(gdp2autho_mean, . ~ . - log(gdp_mean) + log(gdp))

gdppc2leader <- update(gdppc2autho, leader ~ .)
gdp2leader <- update(gdppc2leader, . ~ + log(gdp_mean) - log(gdppc_mean))


list_eco2author <- list(
  gdppc2autho = gdppc2autho,
  gdppc2autho_mean = gdppc2autho_mean,
  gdp2autho = gdp2autho,
  gdp2autho_mean = gdp2autho_mean
)
