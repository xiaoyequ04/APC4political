...
qs::qsave(result_gdppc2dem, "../outputs/result_gdppc2dem.qs", preset = "archive")
```


```{r}
#| echo: fenced
result_mediation_par <- qs::qread("../outputs/result_gdppc2dem.qs")
df_resultMed <- map(result_mediation_par, function(aGroup) {
  map2_df(aGroup, ls_med_std, function(aResult, aMediator) {
    tibble(
      mediator = aMediator,
      effect = "aceB",
...
par(mfrow = c(1,2))
plot(sens_cen2res, sens.par = "rho", main = "Anxiety", ylim = c(-0.2, 0.2))
```
